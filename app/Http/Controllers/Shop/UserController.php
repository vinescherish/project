...
class UserController extends BaseController
{
    ...
    public function lists(Request $request){
        ...
        if (Auth::user()->id===1){
            ...
            $users=User::where('name','like',"%$search%")->where('shop_id', $shopId)->paginate(3);
        }



        return view('Home.shop_users.lists',compact('users','search'));
    }
...
//                跳转
        ...
        return view('Home.shop_users.edit',compact('user'));
    }
    ...
    public function reg(Request $request)
    {
        ...
        return view('Home.shop_users.reg', compact('shopCates'));
    }
...
//         dd($request->post());
        ...
        return view('Home.shop_users.login');
    }
...
//               dd($data['shop_img']);
        ...
        //视图传参数
        return view('Home.shop_users.show',compact('shop'));
    }
}
