...
@section("content")
    <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="name" id="username" placeholder="用户名" style="width: 60%"
                       value="{{$user->name}}">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="password" class="form-control" name="password" placeholder="密码" style="width: 60%"
                       value="{{$user->password}}">
            </div>
        </div>
        <div class="form-group">
            ...
            @if($user->logo)
                <div class="col-sm-1">
                    <img src=" /uploads/{{$user->logo}}" width="80">
                </div>
            @else
                <div class="col-sm-1">
                    <img src=" /uploads/users/logo.jpg" width="80">
                </div>
            @endif
            <div class="col-sm-4">
