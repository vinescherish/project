...
@section("content")
    ...
    <xblock>
        ...
        <button class="layui-btn" onclicks="member_add('添加用户','/shop/member-add.html','600','500')">
            <a href="{{route('user.add')}}"><i class="layui-icon">&#xe608;</i>添加</a></button>
                ...
                <td class="td-status">
                    ...
                    <a title="编辑" href="javascript:;" onclick="member_edit('编辑','member-edit.html','4','','510')"
                       class="ml-5" style="text-decoration:none">
                        <a href="{{route('user.edit',[$user])}}"><i class="layui-icon">&#xe642;</i></a>
                    </a>
                    ...
                    <a title="删除" href="javascript:;" onclick="member_del(this,'1')"
                       style="text-decoration:none">
                        <a href="{{route('user.del',[$user])}}"> <i class="layui-icon">&#xe640;</i></a>
                    </a>
                </td>
            </tr>
        @endforeach
