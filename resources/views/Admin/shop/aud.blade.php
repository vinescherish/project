    ...
    <table class="layui-table">
        ...
        @foreach($users as $user)
            <tr>
               ...
               {{--<td>{{$user->status==1?'是':'否'}}</td>--}}
                {{--<td>{{$user->status}}</td>--}}


                @if($user->status_user==1)
                    <td class="td-status">
                        <span class="layui-btn layui-btn-normal layui-btn-normal">已审核</span>
                    </td>
                @else
                    <td class="td-status">
                        <span class="layui-btn layui-btn-normal layui-btn-danger">待审</span>
                    </td>
                @endif

                <td class="td-status">
                    <a href="{{route('shops.aud',[$user])}}"> <i class="layui-icon">&#xe601;</i></a>
